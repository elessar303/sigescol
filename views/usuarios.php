...
$columnas=array('ID', 'Login', 'Nombre', 'Apellido', 'Rol');
//Consulta SQL
...
<table id="example" class="table table-striped table-hover table-condensed" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <!-- Opciones para cada Registro (ver,editar,etc) -->
                ...
                <a title="Permisologia" href='?mod=<?php echo $opt[0]['id_modulo'];?>&submod=<?php echo $opt[0]['id_submodulo'];?>&opt=delete&cod=<?php echo $reg['id_usuario'];?>' class="btn btn-default btn-xs"><i class="fa fa-lock"></i></a>
                </td>
        </tr>
        <?php } ?>  
        </tbody>
